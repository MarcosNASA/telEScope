import { filterMatchingIdentifiers } from './helpers/index.js';

export const generateVariables = (scopes) => {
  const variableDeclarations = scopes.flatMap(({ variableDeclarations }) => [
        ...
        const variableDeclaration =
          variableDeclarations.find(
            ({ original: originalVariableDeclaration }) =>
              ...
              referenceOriginalVariableDeclaration,
          ) || {};

        const { variableDeclarationId, variableDeclarationScopeId = 0 } =
          variableDeclaration;
        return {
          ...variableReference,
          variableDeclarationId,
          variableDeclarationScopeId,
          variableDeclaration,
        };
      });
