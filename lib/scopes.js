...
export const generateScopes = (rawScopes) => {
  ...
  const { variableDeclarations, variableReferences } =
    generateVariables(scopes);
  ...
  return scopes.map(
    (
      ...
      return {
        ...
        through,
        variables,
        variableReferences: [...new Set([...references, ...through])].map(
          (reference) => {
            ...
            return {
              ...
              isFormalParameterOrIteratorAble:
                ...
                [
                  ...
                  'ForInStatement',
                  'WithStatement',
                ].includes(declarationScopeBlockType),
              isResolved: true,
              original: variable,
              scopeId: scopeId,
            };
